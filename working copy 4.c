...
void	algo_b(t_stack *a, t_stack *b, t_data *data)
{
	...
	//     while (b->top != NULL)
	// {
	//     printf("%d",*(int *)b->top->content);
	//     if( *(int *)b->top->content != 12)
	//         rotate(b, "rb", 1, data);
	//     if(*(int *)b->top->content == 12)
	//     {
	//         push(a, b, 'a', data);
...
void	algo(t_stack *a, t_stack *b, t_data *data)
{
	...
	// Check if current b->top should be inserted at current position in a
	//     if (b->top == NULL
			|| *(int *)a->top->content > *(int *)b->top->content)
	//     {
	//         printf("1\n");
	//         push(a, b, 'b', data);
	//         continue ;
	//     }
	//     // If we have more than one element in b,
		check if next element is better
	//     if (a->top->next != NULL &&
	//         *(int *)a->top->next->content < *(int *)a->top->content)
	//     {
	//         printf("2\n");
	//         swap(a, "sa", 1, data);
	//         continue ;
